  ...
  return (
    <section className="py-12">
      <div className="max-w-5xl mx-auto px-4">
        ...
        {/* Scrollable cards (no side fades) */}
        <div
        ...
        >
          {updates.map((item) => (
            <div
              key={item.id}
              className="w-[300px] bg-white rounded-xl shadow flex-shrink-0 flex flex-col h-full transition-transform duration-300 hover:shadow-xl hover:-translate-y-1"
            >
